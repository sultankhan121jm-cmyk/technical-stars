    ...
    <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16">
      <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-8">
        ...
        >
          ...
          <p className="mt-3 text-sm md:text-base text-[#0A1F3C]/80 max-w-lg mx-auto lg:mx-0">
            Book today and our certified technician will be at your door within 60 minutes. Available 24/7 across all Riyadh districts.
          </p>
        </motion.div>
      ...
      >
        <p className="text-[#0A1F3C]/70 text-xs md:text-sm">
          ✓ No Hidden Charges · ✓ Same Day Service · ✓ Written Warranty
        </p>
      </motion.div>
    </div>
  </section>
